...
knitr::include_graphics('/Users/sarahmorris/Documents/R/QUANT/coral/model-coral_0.png')
...
```{r echo=FALSE}
knitr::include_graphics('/Users/sarahmorris/Documents/R/QUANT/coral/model-coral.png')
```
...
```{r echo=FALSE}
read.csv("/Users/sarahmorris/Documents/R/QUANT/coral/coral_variables.csv")
```
...
coral_state <- c(N = 50)## I think 10 and 50 may be an equilibrium point
...
# Parameters
turf_parameters <- c(a = 0.1,g = 0.8, d = 0.44,r = 1, s = 0.49, M = 100, P = 10, C =50)
...
macro_state <- seq(M = 100)## I think 10 and 50 may be an equilibrium point
times <- seq(0,100,by=1)

# Parameters
macro_parameters <- c(a = 0.1,g = 0.8, d = 0.44,r = 1, s = 0.49, R = 100, P = 10, C =50)
...
parrot_state <- seq(P = 10)## I think 10 and 50 may be an equilibrium point
times <- seq(0,100,by=1)
...
# Solve model and plot results
out1 <- ode(y = parrot_state, times=times,func=parrot,parms=macro_parameters)
par(mfrow=c(1,1))
