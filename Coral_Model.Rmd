...
parrot_state <- seq(P = 10)
times <- seq(0,100,by=1)
test <- seq(0,10,by = 0.1)

# Parameters
parrot_parameters <- c(a = 0.1,g = 0.8, d = 0.44,r = 1, s = 0.49, R = 100, M = 100, C = 0, P = 10)
...
# Solve model and plot results
out1 <- ode(y = test, times=times, func=parrot, parms= parrot_parameters)
par(mfrow=c(1,1))
