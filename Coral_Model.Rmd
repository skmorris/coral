...
**(b) What are the most important parameters in determining the long-term dynamics?**
  - Coral is one of the most important parameters in determing the long-term dynamics; it influences the growth of         every other organism in the system.


``` {r}
### Below, I am trying to make For loops to test our models at different parameters. 

parrot_state <- c(x = seq(0,1, by = 0.1))
